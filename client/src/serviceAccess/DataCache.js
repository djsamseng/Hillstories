...
import picnicChantalDancing from "../img/IMG_2676.jpg";
import profilePictureSam from "../img/UNADJUSTEDNONRAW_thumb_5a.jpg";
...
class DataCache {
    ...
    doLogin({
        ...
        .then(({
            ...
            this.d_profile = {
                name: "Sam Seng",
                profilePicture: profilePictureSam,
            };
        });
    }
    ...
    getStory({
        ...
        .then(() => {
            ...
            contents = contents.concat((new Array(1)).fill(
                {
                    ableToRead: false,
                    image: picnicChantalDancing,
                    text: "Chantal dancing",
                    type: Constants.CONTENT_TYPES.IMAGE,
                }
            ));
